...
export function BottomTabBar() {
  ...
  return (
    <nav
      aria-label="Primary"
      // The trailing safe-area-inset-bottom padding adds the iOS home
      // indicator height (34px in standalone PWA mode, 0 in a normal
      // browser) so the tab labels aren't cut off. Requires
      // viewportFit: "cover" in app/layout.tsx's viewport export.
